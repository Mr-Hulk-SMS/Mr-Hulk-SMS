...
<svg xmlns="http://www.w3.org/2000/svg" width="450" height="195" viewBox="0 0 450 195" fill="none" role="img" aria-labelledby="descId">
        <title id="titleId">Koushik Chatterjee's GitHub Stats, Rank: A-</title>
        <desc id="descId">Total Stars Earned: 695, Total Commits  : 2190, Total PRs: 37, Total Issues: 14, Contributed to (last year): 0</desc>
        <style>
          .header {
    ...
    @keyframes rankAnimation {
      ...
      to {
        stroke-dashoffset: 81.77983408667497;
      }
    }
      ...
      @keyframes fadeInAnimation {
        ...
        <rect data-testid="card-bg" x="0.5" y="0.5" rx="4.5" height="99%" stroke="#e4e2e2" width="449" fill="#141321" stroke-opacity="0"/>

        
      <g data-testid="card-title" transform="translate(25, 35)">
        <g transform="translate(0, 0)">
      <text x="0" y="0" class="header" data-testid="header">Safnas Sarifdeens's GitHub Stats</text>
    </g>
      </g>
    ...
    <g class="stagger" style="animation-delay: 450ms" transform="translate(25, 0)">
      ...
      <text class="stat  bold" x="199.01" y="12.5" data-testid="stars">695</text>
    </g>
  </g><g transform="translate(0, 25)">
    <g class="stagger" style="animation-delay: 600ms" transform="translate(25, 0)">
      
      <text class="stat  bold" y="12.5">Total Commits:</text>
      <text class="stat  bold" x="199.01" y="12.5" data-testid="commits">2.2k</text>
    </g>
  </g><g transform="translate(0, 50)">
    <g class="stagger" style="animation-delay: 750ms" transform="translate(25, 0)">
      
      <text class="stat  bold" y="12.5">Total PRs:</text>
      <text class="stat  bold" x="199.01" y="12.5" data-testid="prs">37</text>
    </g>
  </g><g transform="translate(0, 75)">
    <g class="stagger" style="animation-delay: 900ms" transform="translate(25, 0)">
      
      <text class="stat  bold" y="12.5">Total Issues:</text>
      <text class="stat  bold" x="199.01" y="12.5" data-testid="issues">14</text>
    </g>
